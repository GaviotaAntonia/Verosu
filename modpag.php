      ...
      <div class="container" style="margin-top: 30px">
            ...
            <div class="bs-example">
              <div class="card" style="max-width: 730px;">
                <div class="row no-gutters">
                  <div class="col-md-8" style="background: #E8E183">
                    <div class="card-body">
                      <b>
            ...
            <div class="card-deck">
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Información.</p>
                  <p style="color: #97999b">La implementación de Cisco del RIPv2 apoya a dos modos de autenticación: autenticación de texto únicamente y autenticación del Digesto de mensaje 5 (MD5) El modo del autenticación de texto únicamente es la configuración predeterminada</p>
                  <p style="color: black">
                    <a href="https://www.cisco.com/c/es_mx/support/docs/ip/routing-information-protocol-rip/13719-50.html"><b>Leer más</b></a>
                  </p>
                </div>
              </div>
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Cisco Networking: Mostrar comando de versión en un switch</p>
                  <p style="color: #97999b">En cualquier componente de la red de Cisco, el comando show version es aplicable a cualquier hardware que utilice el Sistema Operativo Internetwork (IOS) de Cisco, incluidos los switches.</p>
                  <p style="color: black">
                    <a href="https://www.akamai.com/es/es/resources/security-compliance.jsp"><b>Conoce más</b></a>
                  </p>
                </div>
              </div>
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Nuevos Routers</p>
                  <p style="color: #97999b">Impulsados por la intención y con información del contexto y seguridad cabal integrada. Nuestros switches ayudan a su red a aprender y evolucionar constantemente para cumplir las necesidades de su negocio.</p>
                  <p style="color: black">
            ...
            <div class="bs-example">
              <div class="card" style="max-width: 730px;">
                <div class="row no-gutters">
                  ...
                  <div class="col-md-4" style="background: #868e96;">
                    <img src="conphoto/ciberataque.jpg" class="card-img-top h-100" alt="...">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="list-group"><br>
            <a href="contacto.php" class="list-group-item list-group-item-action" style="background-color: #800080; color: white;; text-align: center;"><b>Contacto</b><br>
              <button type="" class="btn btn-light btn-sm btn-block">Escribenos a traves de nuestra solicitud en línea</button></a><br><br>
                <a href="#" class="list-group-item list-group-item-action" style="background-color: #800080; color: white; text-align: center;"><b>Solicitud de cotización</b><br><button type="" class="btn btn-light btn-sm btn-block">Enviar Formulario electronico</button></a><br><br>
          </div>
        </div>
        ...
        <div id="accordion">
          ...
          <div class="card"><br>
            <div class="card-header" style="background-color: #800080; color: white"><b>Temas Similares</b></div>
              <div class="card-body">
