    				...
    				<div class="card" style="max-width: 730px;">
    					<div class="row no-gutters">
    						<div class="col-md-8" style="border-top: solid 4px #E33737">
    							<div class="card-body"><b><p style="color: gray">Articulo</p></b>
    		...
    		<div class="col-sm-4">
    			<div class="container">
    				<div class="list-group"><br>
    					<a href="contacto.php" class="list-group-item list-group-item-action" style="background-color: #4AAF9B; color: white;; text-align: center;"><b>Contacto</b><br>
    						...
    						<a href="#" class="list-group-item list-group-item-action" style="background-color: #4AAF9B; color: white; text-align: center;"><b>Solicitud de cotización</b><br>
    							<button type="" class="btn btn-light btn-sm btn-block">Enviar Formulario electronico</button></a><br><br>
    				</div>
    			</div>
    			...
    			<div class="card">
    				...
    				<div class="card-body">
    					...
    					<a href="modpag.php">Edición en Photoshop</a><br>
