            ...
            <div class="bs-example">
              <div class="card" style="max-width: 730px;">
                <div class="row no-gutters">
                  <div class="col-md-8" style="border-top: solid 4px #E33737">
                    <div class="card-body">
                      <b>
                      ...
                      <a href="https://balsamiq.com/wireframes/" class="btn btn-outline#EA6969">Leer más</a>
                    </div>
                  </div>
         ...
         <div class="bs-example">
            ...
            <div class="card-deck">
            	<div class="card text-white" style="border-top: solid 4px #5E4AAF"><br>                
              	...
              	<div class="card text-white" style="border-top: solid 4px #F7EC0A"><br>
              		<div class="card-body animated pulse infinite delay-2s">
              			<p style="color: #97999b; text-align: center;"><b>Cotización</b></p>
            ...
            <div class="bs-example">
            	<div class="card" style="max-width: 730px;">
            		<div class="row no-gutters">                	
            			...
            			<div class="col-md-8" style="background: #3795E3">
