...
<html>
  ...
  <body>
    ...
    <!---FIN DE NAV BAR-->
        ...
        <img class="img-fluid" src="conphoto/routerswi.jpg" width="1800px" style="opacity: 0.4">
        <div class="centrado">
        	<p style="font-size: 60px; color: black;">
        		<b>Configuración de Switch y Router</b>
        	<p style="text-align: right; color: black;">Los switches domésticos para un uso básico de red no necesitan una configuración compleja más allá de la instalación cableada básica y su alimentación.</p>
        </div>
      </div>
              ...
              <div class="card" style="max-width: 730px;">
                <div class="row no-gutters">
                  ...
                  <div class="col-md-4" style="background: #868e96;">
                    <img src="conphoto/switrout.jpg" class="card-img-top h-100" alt="...">
                  </div>
                </div>
              </div>
            </div>
