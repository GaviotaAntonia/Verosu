...
<body>
    ...
    <div class="contenedor" align="center">
        ...
        <div class="centrado"><p style="font-size: 60px"><b>IFRS en México </b><p style="text-align: right;">El equipo de profesionales de Deloitte en IFRS lo ayudará a encontrar la adecuada adopción de las IFRS para su empresa y el cumplimiento de las normativas IFRS en México.</p>
        </div>
    </div>
