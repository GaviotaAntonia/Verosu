...
<html>
    ...
    <body>
        ...
        <div class="contenedor" align="center">
            <img src="conphoto/info54.jpg" class="img-fluid" width="1800px">
        </div>
            ...
            <div class="row">
                <div class="">
                    <div  class="container mt3">
                        ...
                        <h2>Sitios web <i>vs</i> Redes sociales</h2>
                        <p>
                            <small style="color: #76746E">
                                Hoy un tema de mucho pensar para una empresa es donde me publicito si en una página web o en las redes sociales en estos casos te diremos cual te conviene, sus ventajas y desventajas de cada una para que usted pueda saber cual le comiende y empieze a trabajar
                            </small>
                        </p>
                        <br>
