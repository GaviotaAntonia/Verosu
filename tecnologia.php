              ...
              <div class="card" style="max-width: 730px;">
                <div class="row no-gutters">
                  <div class="col-md-8" style="background: #000">
                    <div class="card-body">
                      <b>
                        <p style="color: gray">Acerca de nosotros</p>
                      </b>
                      <h5 class="card-title" style="color: white">Alianzas tecnológicas de Verosu</h5>
                      <p class="card-text" style="color: white">Estamos alineados con más de 30 empresas....</p>
            ...
            <div class="card-deck">
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Robots en la industria</p>
                  <p style="color: #97999b">¿Amenaza necesidad u oportunidad laboral?</p>
                  <p style="color: black">
                    <b>Leer más</b>
                  </p>
                </div>
              ...
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Inonovación SAP con Verosu</p>
                  <p style="color: #97999b">Estamos listos para ayudar a las empresas a reimaginarlo todo</p>
                  <p style="color: black">
                    <b>Conoce más</b>
                  </p>
                </div>
            ...
            <div class="card-deck">
              <div class="card text-white " style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">SAP Enterprise Support</p>
                  <p style="color: #97999b">Beneficios que Verosu brinda por el mantenimiento de sus licencias SAP</p>
                  <p style="color: black">
                    <b>Leer más</b>
                  </p>
                </div>
              ...
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Servicios de soporte AMS</p>
                  <p style="color: #97999b">Diferencias de valor en los servicios de AMS con Verosu</p>
                  <p style="color: black">
                  <b>Conoce más</b>
                  </p>
                </div>
            ...
            <div class="card-deck">
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">SAP C/4HANA</p>
              ...
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Robotics & Cognitive Automation (R&CA)</p>
                  <p style="color: #97999b">Verous ofrece automatización en procesos para hacer negocios más eficiente</p>
                  <p style="color: black">
                    <b>Conoce más</b>
                  </p>
                </div>
              ...
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">El ecosistema del Internet de las cosas</p>
                  <p style="color: #97999b">Descubriendo el valor de los dispositivos para su negocio</p>
                  <p style="color: black">
                    <b>Conoce más</b>
                  </p>
                </div>
            ...
            <div class="card-deck">
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Nivel de madurez digital</p>
                  <p style="color: #97999b">Talento y tecnologías en la era digital</p>
                  <p style="color: black">
                    <b>Conoce más</b>
                  </p>
                </div>
              ...
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Derecho al olvido en Internet</p>
                  <p style="color: #97999b">¿Qué es cómo funciona en México?</p>
                  <p style="color: black">
                    <b>Conoce más</b>
                  </p>
                </div>
                ...
                <div class="row no-gutters">
                  <div class="col-md-8" style="background: #000">
                    <div class="card-body">
                      ...
                      <h5 class="card-title" style="color: white">Navegando la nueva brecha digital</h5>
                      <p class="card-text" style="color: white">Capitalizando la influencia digital en el retail mexicano</p>
                      <a href="#" class="btn btn-light">Leer más</a>
                    </div>
                  </div>
                  <div class="col-md-4" style="background: #868e96;">
