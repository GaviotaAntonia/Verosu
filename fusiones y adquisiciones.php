            ...
            <div class="row no-gutters">
              <div class="col-md-8" style="background: #000">
                <div class="card-body">
                  ...
                  <h5 class="card-title" style="color: white">Tendencias de Fusiones y Adquisiciones 2018</h5>
                    <p class="card-text" style="color: white">Verosu analiza el mercado de M&A al encuestar a más de 1,000 ejecutivos de empresas y firmas de capital privado sobre sus.</p>
        ...
        <div class="card-deck">
          <div class="card text-white ">
            <div class="card-body">
              ...
              <p style="color: black">Continúa el impulso de la mezclilla mexicana en Estados Unidos</p>
              <p style="color: #97999b">Caso de éxito Grupo Siete Leguas</p>
              <p style="color: black">
                <b>Leer más</b>
              </p>
            </div>
          ...
          <div class="card text-white ">
            <div class="card-body">
              ...
              <p style="color: black">Los signos vitales del mercado de fusiones y adquisiciones</p>
              <p style="color: black">
                <b>Descubre más</b>
              </p>
            </div>
          ...
          <div class="card text-white">
            <div class="card-body">
              ...
              <p style="color: black">Corrupción vs Honestidad</p>
              <p style="color: #97999b">En este e-book, ofreceremos nuestra perspectiva acerca...</p>
              <p style="color: black">
                <b>Leer más</b>
              </p>
            </div>
            ...
            <div class="row no-gutters">
              <div class="col-md-8" style="background: #000">
                <div class="card-body">
                  ...
                  <h5 class="card-title" style="color: white">Fusiones y Adquisiciones 2017</h5>
                    <p class="card-text" style="color: white">Te invitamos a leer nuestro reporte de mercado de Fusiones y Adquisiciones en México en el...</p>
                    <a href="#" class="btn btn-light">Descargar aquí el reporte</a>
                </div>
              </div>
              <div class="col-md-4" style="background: #868e96;">
                <img src="conphoto/1.jpeg" class="card-img-top h-100" alt="...">
