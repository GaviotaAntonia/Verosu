            ...
            <div class="card" style="max-width: 730px">
              ...
              <div class="col-sm-7">
                <div class="card-body">
                  ...
                  <h5 class="card-title">¿Relanzar una marca del pasado o crear una nueva?</h5>
                  <p class="card-text" style="color: black">Apostar por una marca en el olvido puede generar, en ocasiones, grandes beneficios para las empresas, las cuales, antes de tomar una</p>
          ...
          <div class="card-deck">
            <div class="card text-white ">
              ...
              <div class="card-body">
                ...
                <p style="color: black">¿A quién beneficia la Reforma Laboral?</p>
                <p style="color: black">
                  <b>Leer más</b>
                </p>
              </div>
            ...
            <div class="card text-white" style="background: #000; border-top: solid 5px #ff9786">
              <div class="card-body">
                ...
                <p style="color: white">Reformas a la Ley Federal del Trabajo</p>
                <p style="color: white">
                  <b>leer más</b>
                </p>
              </div>
            ...
            <div class="card text-white ">
              <div class="card-body">
                ...
                <p style="color: black">Ley de la Propiedad Industrial</p>
                <p style="color: #97999b">Estos son los cambios que debes conocer</p>
                <p style="color: black">
                  <b>Leer más</b>
                </p>
              </div>
