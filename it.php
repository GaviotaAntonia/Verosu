...
<body>
  ...
  <div class="contenedor" align="center">
  	...
  	<div class="centrado">
  		<p style="font-size: 60px; color: black;"><b>Integración Tecnológica</b>
	...
	<div class="row">
		<div class="col-sm-8">
			<div class="container mt-4">
                ...
                <br><br>
                <p style="color: black">Somos socios estratégicos de los principales fabricantes de Tecnologías de Información como: HP, IBM, ECM, SAS, Teradata, Informatica, TIBCO, entre otros.</p>
                <br>El amplio conocimiento de industria y expertise local y global de nuestros profesionales, nos permite contar con una visión profunda en los temas de tecnología y su relación e impacto en el negocio, para proveer soluciones integrales de valor.<br><br>
        	...
        	<div class="container">
        		<div class="list-group"><br>
        			<a href="contacto.php" class="list-group-item list-group-item-action" style="background-color: #58b4a6; color: black;"><b>Contacto</b><br>
        				...
        				<br><a href="#" class="list-group-item list-group-item-action" style="background-color: #58b4a6; color: black;"><b>Solicitud de cotización</b><br><button type="" class="btn btn-light btn-sm btn-block">Enviar Formulario electronico</button></a><br><br>
