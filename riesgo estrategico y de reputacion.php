              ...
              <div class="card" style="max-width: 730px;">
                <div class="row no-gutters">
                  <div class="col-md-8" style="background: #000">
                    <div class="card-body">
                      <b>
                        <p style="color: gray">Análisi</p>
                      </b>
                      <h5 class="card-title" style="color: white">Alerta para Consejeros</h5>
                      <p class="card-text" style="color: white">¿Cómo pueden los consejos introducir el pensamiento a largo plazo en fu función de supervisión?</p>
                      <a href="#" class="btn btn-light">Leer infografia</a>
                    </div>
                  </div>
            ...
            <div class="card-deck">
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Riesgo Estratégico y Reputacional</p>
                  <p style="color: #97999b">Ofrecemos soluciones innovadoras y prácticas en torno a la gestión de riegos estratégicos, el manejo de crisis y los riesgos de marca y reputación</p>
                  <p style="color: black">
                    <b>Conozca más</b>
                  </p>
                </div>
              ...
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Mujeres en los Consejos de Administración</p>
                  <p style="color: #97999b">Nuestro estudio explora los esfuerzos de 50 países para promover la diversidad de género...</p>
                  <p style="color: black">
              ...
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Los retos de la disrupción digital</p>
                  <p style="color: #97999b">¿Cómo pueden prepararse las empresas?</p>
                  <p style="color: black">
                    <b>Conozca más</b>
                  </p>
                </div>
                ...
                <div class="row no-gutters">
                  <div class="col-md-8" style="background: #000">
                    <div class="card-body">
                      ...
                      <h5 class="card-title" style="color: white">Desafíos del consejo de administración en la tecnología</h5>
                      <p class="card-text" style="color: white">En este boletín hablaremos de algunos movimientos tácticos que sugiere...</p>
            ...
            <div class="card-deck">
              <div class="card text-white " style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Gobierno Corporativo</p>
                  <p style="color: #97999b">Las práctias de gobierno corporativo se han desarrollado buscando mejoras las práctias administrativas y el desempeño del Consejo de Administración como responsable de la estragia y vigilancia de la empresa</p>
                  <p style="color: black">
                    <b>Conozca más</b>
                  </p>
                </div>
              ...
              <div class="card text-white" style="border-top: solid 4px #009975">
                <div class="card-body">
                  ...
                  <p style="color: black">Sustentabilidad</p>
                  <p style="color: #97999b">Algunos de los temas que engloba la sustentabilidad son: emisiones de gases de efectos invernadero, gestión de nergía y agua, huella de carbono, equidad, practicas de ética, responsabilidad del producto, entre otros</p>
                  <p style="color: black">
                  <b>Conozca más</b>
                  </p>
                </div>
                ...
                <div class="row no-gutters">
                  <div class="col-md-8" style="background: #000">
                    <div class="card-body">
                      ...
                      <h5 class="card-title" style="color: white">Encuestas Diagnóstico de Gobierno Corporativo</h5>
                      <p class="card-text" style="color: white">¿Ya conoces el nivel de madurez de tu gobierno corporativo?</p>
                      <a href="#" class="btn btn-light">Evaluar empresa</a>
                    </div>
                  </div>
                  <div class="col-md-4" style="background: #868e96;">
                    <img src="conphoto/1.jpeg" class="card-img-top h-100" alt="...">
