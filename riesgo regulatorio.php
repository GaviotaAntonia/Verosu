...
<html>
  ...
  <body>
    ...
    <!---FIN DE NAV BAR-->
      ...
      <img class="img-fluid" src="conphoto/111.jpg" width="1800px" style="opacity: 0.4">
      <div class="centrado">
              ...
              <div class="row no-gutters">
                <div class="col-md-8" style="background: #fff">
                  <div class="card-body">
                    ...
                    <h5 class="card-title" style="color: black">El cambiante entorno regulatorio de las Fintech</h5>
                    <p class="card-text" style="color: black">Las empresas de Fintech (Tecnologia Financiera) ganan terreno con productos innovadores y...</p>
          ...
          <div class="card-deck">
            <div class="card text-white " style="border-top: solid 4px #009975">
              <div class="card-body">
                ...
                <p style="color: black">Integridad del cumplimento regulatorio global de ciberseguridad</p>
                <p style="color: #97999b">Un reto desalentador pero manejable</p>
                <p style="color: black">
                  <b>Leer más</b>
                </p>
              </div>
            ...
            <div class="card text-white" style="border-top: solid 4px #009975">
              <div class="card-body">
                ...
                <p style="color: black">Cambios regulatorios en el sector asegurador y afianzador mexicano</p>
                <p style="color: #97999b">Vision estrategica de la nueva Ley de Instituciones de seguros y de fianzas</p>
                <p style="color: black">
                  <b>Leer más</b>
                </p>
              </div>
              ...
              <div class="row no-gutters">
                <div class="col-md-8" style="background: #000">
                  <div class="card-body">
                    ...
                    <h5 class="card-title" style="color: white">Riesgo Regulatorio:</h5>
                    <p class="card-text" style="color: white">Esta enfocados a asistir a nuestros clientes para que puedan cumplir con sus objetivos de negocio sin incurrir en riesgos de cumplimento con normativas locales o globales</p>
                    <a href="#" class="btn btn-light">Leer más</a>
                  </div>
                </div>
                <div class="col-md-4" style="background: #868e96;">
