...
<!--FINAL NAV-->
<body>
 <img src="conphoto/pag.bus.jpg" alt="" style="width: 100%">
 <hr style="border-top: solid 4px #51A35A;">
  ...
  <div class="row">
    <div class="col-sm-8">
         <div class="container mt-3">
          ...
          <h2>Gestión de Talento<small style="color: #76746E"><BR>Liderando el nuevo mundo del trabajo</small></h2><br><br>
          <img src="logosocial/social_facebook_fb_35 .png" alt="..." class="img-circle">
          <img src="logosocial/social_instagram_3.png" alt="..." class="img-circle">
         
          <img src="logosocial/social_youtube_23.png" alt="..." class="img-circle">
