  ...
  <body>
    ...
    <!---FIN DE NAV BAR-->
      ...
      <div class="centrado">
        ...
        <p style="text-align: right; color: black;">Entérese a través de nuestros flashes fiscales de las noticias más relevantes sobre temas fiscales a nivel nacional.</p>
      </div>
    </div>
              ...
              <div class="row no-gutters">
                <div class="col-md-8" style="background: #000">
                  <div class="card-body">
                    ...
                    <h5 class="card-title" style="color: white">Solicitud de suspensión de convocatorias del CONACYT</h5>
              ...
              <div class="row no-gutters">
                <div class="col-md-8" style="background: #000">
                  <div class="card-body">
                    ...
                    <h5 class="card-title" style="color: white">Verosu tax@hand</h5>
                    <p class="card-text" style="color: white">Ahora, con más países, la fuente de noticias fiscales de Verosu Tax@hand ofrecemos información relevante en español y en inglés de México, América...</p>
                    <a href="#" class="btn btn-light">Descargue aquí la app</a>
                  </div>
                </div>
                <div class="col-md-4" style="background: #868e96;">
                  <img src="conphoto/1.jpeg" class="card-img-top h-100" alt="...">
